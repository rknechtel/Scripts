...
REM Count Messages in JMS Queue
echo The Number of Messages in JMS Queue %JMSQ% is/are:
%JBOSS_HOME%\bin\jboss-cli.bat --connect --controller=%APPSRV% --command="/subsystem=messaging/hornetq-server=default/jms-queue=%JMSQ%:count-messages"
...
:usage
set ERRORNUMBER=1
echo [USAGE]: countjmsmsg.bat arg1 arg2
