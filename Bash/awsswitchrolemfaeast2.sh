#!/bin/bash
# *********************************************************************
# Script: awsswitchrolemfaeast2.sh
# Author: Richard Knechtel
# Date: 08/05/2021
# Description: This will switch user to specified role and set
#              necessary environment variables. For us-east-2.
#
# Parameters: Role ARN
...
#                Or:
#                1Password --> <Key Name> --> One-time password
#
...
#
# Example Call (bash)
# source awsswitchrolemfaeast2.sh <ROLE ARN> <ROLE SESSION NAME> <TOKEN CODE FROM KEEPASS>
#
#
# *********************************************************************
...
usage()
{
  echo "[USAGE]: awsswitchrolemfaeast2.sh arg1 arg1 arg3"
  echo "arg1 = Role ARN (from .aws/config) (Example: arn:aws:iam::123456789012:role/production-admin-cross-account-role)"
  echo "arg2 = Role Session Name (Example: AWSCLI-Session)"
  echo "arg3 = Token Code (from  Keepass or 1Password) (Example: 123456)"
...
if [[ $UNSUPPORTED_OS == 0 ]]; then
  ...
  export AWS_PROFILE=$(echo rknechteleast2)
  export AWS_DEFAULT_REGION=$(echo us-east-2) 
