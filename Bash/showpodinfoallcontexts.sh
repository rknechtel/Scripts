#!/bin/bash
# *********************************************************************
# Script: showpodinfoallcontexts.sh
# Author: Richard Knechtel
# Date: 06/10/2022
# Description: This will let you shows pod info in namespaces in all contexts.
#
...
#
# Example Call (bash)
# source showpodinfoallcontexts.sh <NAMESPACE>(Optional)
#
#
# *********************************************************************
